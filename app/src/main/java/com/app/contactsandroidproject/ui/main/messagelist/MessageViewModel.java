...
public class MessageViewModel extends BaseViewModel<MessageNavigator> {
    ...
    private final MutableLiveData<List<Contact>> messageListLiveData;
    ...
    public void loadMessagesCards() {
        setIsLoading(true);
        getCompositeDisposable().add(getDataManager()
                .getsendMessageContactCardData(true)
                ...
                .subscribe(contactList -> {
                    if (contactList != null) {
                        ...
                        messageListLiveData.setValue(contactList);
                    }
                    setIsLoading(false);
                }, throwable -> {
                    setIsLoading(false);
    ...
    public LiveData<List<Contact>> getMessageListLiveData() {
