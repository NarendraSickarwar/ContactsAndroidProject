...
public class MessageItemViewModel {
    ...
    public final ObservableField<String> CreatedAt;
    ...
    public MessageItemViewModel(Contact contact, ContactItemViewModelListener listener) {
        ...
        otp = new ObservableField<>(contact.getOtp());
        CreatedAt = new ObservableField<>("" + contact.getCreatedAt());
    }

    public void onItemClick() {
        mListener.onItemClick("http://www.suitdoctors.com/wp-content/uploads/2016/11/dummy-man-570x570.png");
    }
