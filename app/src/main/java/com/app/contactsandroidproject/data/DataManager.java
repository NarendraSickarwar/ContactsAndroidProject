...
public interface DataManager extends DbHelper, PreferencesHelper, ApiHelper {
    ...
    Observable<List<Contact>> getContactCardData();

    Observable<List<Contact>> getsendMessageContactCardData(boolean sendMsg);

    Observable<Boolean> getUpdateContacts(Contact contact);

    Observable<Boolean> seedDatabaseContacts();
